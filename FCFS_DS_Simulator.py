...
class Ui_MainWindow():
    def setupUi(self, MainWindow):
        ...
        self.actionFCFS_Disk_Scheduling.triggered.connect(lambda: webbrowser.open_new_tab('https://www.tutorialspoint.com/operating_system/os_fcfs_scheduling_algorithm.htm'))
